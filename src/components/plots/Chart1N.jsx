...
class Chart1 extends Component {
  chartPlotsView1() {
    ...
    Highcharts.chart("chartPlotsView1", {
      chart: {
        type: "column",
        renderTo: "chartPlotsView1",
  ...
  render() {
    ...
    return (
      ...
      >
        <div id="chartPlotsView1" className={fullScreen ? "chartPlotsViewFullScreen" : "chartPlotsView2"} />
      </ChartCard>
    );
  }
}
